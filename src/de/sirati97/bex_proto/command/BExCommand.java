...
public class BExCommand<t1,t2,t3,t4,t5,t6,t7,t8,t9,t10> implements VoidExtractor{
	...
	public Stream send(t1 arg1, t2 arg2, t3 arg3, t4 arg4, t5 arg5, t6 arg6, t7 arg7, t8 arg8, t9 arg9, t10 arg10) {
		Stream[] streams = new Stream[handlers.length];
		switch (handlers.length) {
		case 10:
			streams[9]=handlers[9].createStream(arg10);
		case 9:
			streams[8]=handlers[8].createStream(arg9);
		case 8:
			streams[7]=handlers[7].createStream(arg8);
		case 7:
			streams[6]=handlers[6].createStream(arg7);
		case 6:
			streams[5]=handlers[5].createStream(arg6);
		case 5:
			streams[4]=handlers[4].createStream(arg5);
		case 4:
			streams[3]=handlers[3].createStream(arg4);
		case 3:
			streams[2]=handlers[2].createStream(arg3);
		case 2:
			streams[1]=handlers[1].createStream(arg2);
		case 1:
			streams[0]=handlers[0].createStream(arg1);
		default:
			break;
		}
