...
import de.sirati97.bex_proto.DataHandler2.DerivedTypeBase;
...
import de.sirati97.bex_proto.DataHandler2.TypeBase;
import de.sirati97.bex_proto.v1.network.NetConnection;

public class BEx6Command<t1,t2,t3,t4,t5,t6> implements CommandBase{
	TypeBase[] types;
	private short id;
	private CommandBase parent;
	
	public BEx6Command(short id, TypeBase...types) {
		this.types = types;
		this.id = id;
	}
	...
	public Void extract(ByteBuffer dat) {
		...
		receive((t1)r[0],(t2)r[1],(t3)r[2],(t4)r[3],(t5)r[4],(t6)r[5], dat.getSender());
		return null;
	}
	
	public void receive(t1 arg1, t2 arg2, t3 arg3, t4 arg4, t5 arg5, t6 arg6, NetConnection sender) {
		
	}


	public Stream send(t1 arg1, t2 arg2, t3 arg3, t4 arg4, t5 arg5, t6 arg6) {
	...
	public void send(t1 arg1, t2 arg2, t3 arg3, t4 arg4, t5 arg5, t6 arg6, NetConnection... connections) {
		send(send(arg1, arg2, arg3, arg4, arg5, arg6), connections);
	}
