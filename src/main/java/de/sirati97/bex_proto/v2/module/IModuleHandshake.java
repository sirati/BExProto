...
public interface IModuleHandshake extends IModule {
    void onHandshake(ModularArtifConnection connection, ICallback callback) throws Throwable;
    /**Only for preparing. DO NOT SEND PACKETS HERE*/
    void onHandshakeServerSide(ModularArtifConnection connection, ICallback callback) throws Throwable;
