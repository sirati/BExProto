...
public class ServerModularArtifConnection extends ModularArtifConnection implements IServerConnection {
    public ServerModularArtifConnection(AsyncHelper asyncHelper, IOHandler ioHandler, ModuleHandler moduleHandler) {
        super("NewConnection", asyncHelper, ioHandler, moduleHandler);
    }
