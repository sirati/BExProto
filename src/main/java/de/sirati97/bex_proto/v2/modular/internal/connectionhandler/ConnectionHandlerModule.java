...
public class ConnectionHandlerModule extends InternalModule<ConnectionHandlerModule.ConnectionHandlerData>{
    ...
    @Override
    public ConnectionHandlerData createData(ModularArtifConnectionService connection) {
        return new ConnectionHandlerData();
    }

    public void sendHandshakeRequest(ModularArtifConnectionService connection, ICallback handshakeCallback) {
    ...
    public void sendHandshakeExchangeData(ModularArtifConnectionService connection) {
    ...
    public void sendHandshakeFinished(ModularArtifConnectionService connection) {
        ConnectionHandlerData data = getModuleData(connection);
    ...
    public void initServerSide(ModularArtifConnectionService connection, ICallback handshakeCallback) {
        getModuleData(connection).callback = handshakeCallback;
    }

    public void finishServerSide(ModularArtifConnectionService connection) {
        ConnectionHandlerData data = getModuleData(connection);
        data.callback = null;
