 ...
 */
public class ModularService extends BasicService {
    ...
    public ModularService(String connectionName, IOHandler ioHandler, ModuleHandler moduleHandler) {
        ...
        getAsyncHelper().runAsync(new Runnable() {
            ...
            public void run() {
                try {
                    connect();
                    if (result != null) {
                        result.onConnected(ModularService.this);
                    }
                } catch (Exception e) {
                    if (result != null) {
                        result.onException(ModularService.this, e);
                    }
                }
            ...
            getAsyncHelper().runAsync(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        moduleHandler.connectionHandlerModule.initServerSide(ModularService.this, data);
                        ...
                        connectionEstablished = true;
                        moduleHandler.connectionHandlerModule.finishServerSide(ModularService.this);
            ...
            getAsyncHelper().runAsync(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        ModularService.super.expectConnection();
